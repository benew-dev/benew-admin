// app/dashboard/applications/[id]/not-found.jsx - APPLICATION NOT FOUND PAGE
import Link from 'next/link';
import styles from '@/ui/styling/dashboard/applications/singleNotFound.module.css';

/**
 * APPLICATION NOT FOUND (404) PAGE - Server Component
 *
 * Production-ready 404 handler for single application route (5 users/day):
 ...
 * - /dashboard/applications/non-existent-uuid
 * - /dashboard/applications/invalid-id-format
 * - /dashboard/applications/deleted-application-id
    ...
    <div className={styles.notFoundContainer}>
      <div className={styles.notFoundCard}>
        ...
        <p className={styles.notFoundDescription}>
          The application you&apos;re looking for doesn&apos;t exist or may have
          been deleted. Please check the application ID or return to the
          applications list.
        </p>
