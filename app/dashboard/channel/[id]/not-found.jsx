// app/dashboard/channel/[id]/not-found.jsx
import Link from 'next/link';
import styles from '@/ui/styling/dashboard/channel/singleNotFound.module.css';
    ...
    <div className={styles.notFoundContainer}>
      <div className={styles.notFoundCard}>
        ...
        <p className={styles.notFoundDescription}>
          ...
          deleted. Please check the video ID or return to the channel list.
        </p>
